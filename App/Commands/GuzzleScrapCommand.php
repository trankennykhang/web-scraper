...
use Scraper\App\Infrastructure\GuzzleCrawler;
use Scraper\App\Infrastructure\GuzzleBrowser;
use Scraper\App\Helper\CssSelector;

// the name of the command is what users type after "php bin/console"

#[AsCommand(name: 'guzzle', description: 'Scrap web for data')]
class GuzzleScrapCommand extends ScrapCommand
{
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $siteClass = new $class(GuzzleBrowser::createGuzzleBrowser(), new GuzzleCrawler(), new CssSelector());
